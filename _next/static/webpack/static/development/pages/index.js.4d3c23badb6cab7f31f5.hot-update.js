...
function Carousel(_ref) {
  ...
  var handleNext = function handleNext() {
    return x.set(-(x.get() + width));
  };

  var handlePrev = function handlePrev() {
    return x.set(-((x.get() - 1) % children.length * width));
  };
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    var unsubscribe = x.onChange(console.log);
    return unsubscribe;
  }, []);
  console.log(x);
  return __jsx("div", {
...
//# sourceMappingURL=index.js.4d3c23badb6cab7f31f5.hot-update.js.map