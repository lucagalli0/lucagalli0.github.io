...
function Carousel(_ref) {
  ...
  var scale = sc.interpolate({
    range: [prevSlide > slide ? slide : prevSlide, prevSlide > slide ? prevSlide : slide],
    output: [0, 1],
    extrapolate: 'clamp'
  }).interpolate({
    range: [0, 0.5, 1],
...
function usePrevious(value) {
  ...
  var ref = react__WEBPACK_IMPORTED_MODULE_3__["useRef"](); // Store current value in ref
...
//# sourceMappingURL=index.js.87c960c7f695d7fa2b40.hot-update.js.map