...
function Carousel(_ref) {
  ...
  var activeBulletOffset = x.interpolate(function (off) {
    return "translateX(".concat(off, "rem)");
  });
  var activeBulletScale = x.interpolate({
  ...
  return __jsx(_chakra_ui_core__WEBPACK_IMPORTED_MODULE_6__["Box"], Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
    ...
    style: {
      ...
      backgroundColor: 'red',
      position: 'absolute',
      transform: "".concat(activeBulletOffset, " ").concat(activeBulletScale)
    },
    __self: this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.a3aa92050dd7f7890dc9.hot-update.js.map