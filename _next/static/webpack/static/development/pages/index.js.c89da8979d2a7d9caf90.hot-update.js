...
function Carousel(_ref) {
  ...
  var _ref$activeIndex = _ref.activeIndex,
      ...
      props = Object(_babel_runtime_helpers_esm_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_3__["default"])(_ref, ["activeIndex", "auto", "children"]);
  ...
  var _useSprings = Object(react_spring__WEBPACK_IMPORTED_MODULE_5__["useSprings"])(children.length, function (index) {
    return {
      offset: index
    };
  }),
  ...
  var bulletProps = Object(framer_motion__WEBPACK_IMPORTED_MODULE_8__["useSpring"])({
    transform: "translateX(".concat((slide + 1) * 2, "rem)")
  });
  console.log(bulletProps);
  return __jsx(_chakra_ui_core__WEBPACK_IMPORTED_MODULE_7__["Box"], Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_1__["default"])({
    minH: "320px",
    w: "100%",
    ref: sliderRef
  }, props, {
  ...
  })), children.length > 1 ? __jsx(_chakra_ui_core__WEBPACK_IMPORTED_MODULE_7__["Flex"], {
    mx: [2, 8, 24],
    alignItems: "center",
    position: "relative",
    __self: this,
    ...
    w: "1rem",
    borderRadius: "50%",
    backgroundColor: "green.200" // transition="background-color 0.2s linear"
    // cursor="pointer"
    ,
    position: "absolute",
    style: _objectSpread({
...
var AnimatedBox = Object(react_spring__WEBPACK_IMPORTED_MODULE_5__["animated"])(_chakra_ui_core__WEBPACK_IMPORTED_MODULE_7__["Box"]);

/***/ })

})
//# sourceMappingURL=index.js.c89da8979d2a7d9caf90.hot-update.js.map