...
/* harmony import */ var _carousel_module_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./carousel.module.css */ "./src/components/Carousel/carousel.module.css");
/* harmony import */ var _carousel_module_css__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_carousel_module_css__WEBPACK_IMPORTED_MODULE_4__);
...
function Carousel(props) {
  var _useDimensions = useDimensions(),
      _useDimensions2 = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_useDimensions, 2),
      ref = _useDimensions2[0],
      width = _useDimensions2[1].width;

  return __jsx("div", {
    ref: ref,
    className: _carousel_module_css__WEBPACK_IMPORTED_MODULE_4___default.a.container,
    __self: this,
    __source: {
  ...
  }, width ? __jsx(CarouselItems, Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_1__["default"])({
    width: width
  }, props, {
    __self: this,
    __source: {
...
function CarouselItems(_ref) {
  ...
  var index = react__WEBPACK_IMPORTED_MODULE_3__["useRef"](0).current;

  var _useSprings = Object(react_spring__WEBPACK_IMPORTED_MODULE_5__["useSprings"])(children.length, function (i) {
    return {
      x: i * width,
      sc: 1,
      display: 'block'
      ...
      _useSprings2 = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_useSprings, 2),
      props = _useSprings2[0],
      set = _useSprings2[1];

  var bind = Object(react_use_gesture__WEBPACK_IMPORTED_MODULE_6__["useDrag"])(function (_ref2) {
    var down = _ref2.down,
        _ref2$movement = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_ref2.movement, 1),
        mx = _ref2$movement[0],
        _ref2$direction = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_ref2.direction, 1),
        xDir = _ref2$direction[0],
        distance = _ref2.distance,
        cancel = _ref2.cancel;

    if (down && distance > width / 2) cancel(index = (Object(_babel_runtime_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_0__["default"])("index"), clamp(index + (xDir > 0 ? -1 : 1), 0, children.length - 1)));
    set(function (i) {
  ...
  return props.map(function (_ref3, i) {
    var x = _ref3.x,
        ...
        sc = _ref3.sc;
    return __jsx(react_spring__WEBPACK_IMPORTED_MODULE_5__["animated"].div, Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_1__["default"])({}, bind(), {
      key: i,
      style: {
        display: display,
        position: 'absolute',
...
function useDimensions() {
  ...
  var ref = react__WEBPACK_IMPORTED_MODULE_3__["useCallback"](function (node) {
    setNode(node);
  }, []);
...
//# sourceMappingURL=index.js.17346d868cc01a8bc2c5.hot-update.js.map