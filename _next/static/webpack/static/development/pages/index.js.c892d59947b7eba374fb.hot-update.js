...
var Track = function Track(_ref2) {
  ...
  function onDragEnd(event, info) {
    ...
    controls.start({
      x: allowSlideToLast ? closestPosition : Math.max(closestPosition, windowDimensions.innerWidth - trackDimensions.width - ( // TODO: real track wrapper left/right offsets that should be live!
  ...
  return __jsx(TrackWrapper, {
    ...
    drag: "x",
    dragConstraints: {
      left: allowSlideToLast ? lastItem + gap - trackDimensions.width : windowDimensions.innerWidth - trackDimensions.width - ( // TODO: real track wrapper left/right offsets that should be live!
      trackDimensions.x + trackDimensions.x),
      right: 0
    },
    onDragEnd: onDragEnd,
...
//# sourceMappingURL=index.js.c892d59947b7eba374fb.hot-update.js.map